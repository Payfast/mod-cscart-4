REPLACE INTO cscart_payment_processors (`processor`,`processor_script`,`processor_template`,`admin_template`,`callback`,`type`) VALUES ('PayFast','payfast.php', 'processor_payfast.tpl','admin_payfast.tpl', 'N', 'P');
